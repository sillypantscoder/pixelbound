...
public class AssetLoader {
	...
	/**
	 * Check whether the program is being run as a jar file (as opposed to java --class-path ...)
	 * @return True if the program is a jar file, False otherwise.
	 */
	 ...
	 * @return A File object indicating the requested resource.
	 */
